...
<html lang="zh-cn" class="csstransitions cssanimations ic_webkit ic_chrome ic_latest">
    <head>
        ...
        <link rel="stylesheet" href="/yixun/Public/home/css/style.css" type="text/css" media="screen">
                    <!--[if !IE]>|xGv00|8d8871c57bdd50638a9c8dbef4b4e250<![endi<>f]-->
        
	<link rel="stylesheet" href="/yixun/Public/home/css/gb1.css" type="text/css" media="screen">
	<link rel="stylesheet" href="/yixun/Public/home/css/style1.css" type="text/css" media="screen">

        <!--[if !IE]>|xGv00|862996b1d71bcbc1ca1b249e59fcf6e2<![endif]-->
        <!--[if IE]>
        <link rel="stylesheet" href="/yixun/Public/home/css/ie.css" type="text/css" media="screen">
        <![endif]-->
    </head>
    <body class="ic_rwd">
        <!--[if IE]>
                ...
                <div class="mod_sitemap" role="navigation">
                    <ul class="mod_sitemap_ul" id="j_sitemap">
                        <?php if(empty($_SESSION[uname])): ?><li class="mod_sitemap_li">
                                <a href="/yixun/index.php/home/login">登录&nbsp;</a>
                            </li>
                            <li class="mod_sitemap_gap">|</li>
                            <li class="mod_sitemap_li">
                                <a href="/yixun/index.php/home/register">注册&nbsp;</a>
                            </li>
                            <?php else: ?>
                            <li class="mod_sitemap_li">
                                欢迎您，<a target="_blank" ><a href="/yixun/index.php/home/center"><?php echo (session('uname')); ?></a>&nbsp;</a>
                            </li>
                            <li class="mod_sitemap_gap">|</li>
                            <li class="mod_sitemap_li">
                                <a target="_blank" href="/yixun/index.php/home/center">我的易迅&nbsp;</a>
                            </li>
                            <li class="mod_sitemap_gap">|</li>
                            <li class="mod_sitemap_li">
                                <a  href="/yixun/index.php/home/index/exitlogin">退出&nbsp;</a>
                            </li><?php endif; ?>
                        
                        
                        <li class="mod_sitemap_gap">|</li>
                        <li class="mod_sitemap_li">
                                <a target="_blank" href="/yixun/index.php/Home/Center/indent">我的订单&nbsp;</a>
                            </li>
                        <li class="mod_sitemap_gap">|</li>
                        <li class="mod_sitemap_li">
                            <a target="_blank" href="/yixun/index.php/Home/Service">服务中心&nbsp;</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="ic_header">
                <div class="grid_c1">
                    ...
                    <div class="mod_logo">
                        <h1>
                            <!--<a href="/yixun/index.php/Home/Index/index"><img src="/yixun/Public/home/images/logo_2013_v1.png" alt="易迅网"></a>-->
                            <a href="/yixun/index.php/Home/Index/index"><img src="/yixun/Public/Uploads/<?php echo (implode('/',explode('/',$web["wlogo"]))); ?>" alt="易迅网"></a>
                        </h1>
                    </div>
                    ...
                    <div class="mod_city" id="j_mod_city">
                        ...
                        <a target="_blank" href="/yixun/index.php/Home/Index/index" >购物满49元免运费，晚上买明早到</a>
                        </p>
                    </div>
                    ...
                    <div class="search_cart_wrap" id="j_search">
                        ...
                        <div class="mod_minicart" id="j_minicart">
                            <div class="mod_minicart_con">
                                <a href="/yixun/index.php/Home/Showcart/index" class="mod_minicart_lk">
	...
	<div class="ic_content xcontent">
		...
		<div class="grid_c1 xcontent_row1">
			<!-- 商品路径面包线导航 -->
			<div class="mod_crumb">
				<a href="/yixun/index.php/home/index"><strong>首页</strong></a>
				<?php if(is_array($line)): foreach($line as $key=>$vo): ?><i>&gt;</i><a href="/yixun/index.php/Home/Search/index/cid/<?php echo ($vo["cid"]); ?>.html" class="lk_0"><?php echo ($vo["cname"]); ?></a><?php endforeach; endif; ?>
		...
		<div class="grid_c1 xcontent_row2" itemscope="" itemtype="http://schema.org/Product">
			<div class="grid_s">
						...
						<div class="xgallery_thumb_wrapper" id="list_smallpic">
							...
							<ul style="width: 425px;" class="xgallery_thumb_list clearfix">
								<li class="current" idx="0">
									<a hidefocus="true"><img src="/yixun/Public/goodsuploads/<?php echo ($sxw_goodsPic[0]); ?>"></a>
								</li>
								<li idx="1">
									<a hidefocus="true"><img src="/yixun/Public/goodsuploads/<?php echo ($sxw_goodsPic[1]); ?>"></a>
								</li>
								<li idx="2">
									<a hidefocus="true"><img src="/yixun/Public/goodsuploads/<?php echo ($sxw_goodsPic[2]); ?>"></a>
								</li>
								<li idx="3">
									<a hidefocus="true"><img src="/yixun/Public/goodsuploads/<?php echo ($sxw_goodsPic[3]); ?>"></a>
								</li>
								<li idx="4">
									<a hidefocus="true"><img src="/yixun/Public/goodsuploads/<?php echo ($sxw_goodsPic[4]); ?>"></a>
								</li>
							</ul>
						</div>
					</div>
				...
				<div class="xsns clearfix">
					<div class="xfav">
						<a id="sea_add_favor" href="/yixun/index.php/Home/Goods/goodsCollection/gid/<?php echo ($item["gid"]); ?>" class="mod_btn mod_btn_bg1" ytag="24300"><span>收藏</span></a>
					</div>
					<div class="xshare">
							...
							<div style="display: block;" class="xscan hide" id="sea_code_wrap">
	  							<div class="xscan_col1">
									<div class="xscan_code" id="sea_code">
	  									<img src="/yixun/Public/images/qrcode.png" _src="http://api.item.yixun.com/2dcode/qrcode?scene=item&amp;size=80&amp;param=P%3D1118345%26Y%3D1500000" alt="商品二维码" width="80">
									</div>
	  							</div>
	  							<div class="xscan_col2">
									...
									<div class="xscan_bigcode" id="sea_bigcode">
	  									<img src="/yixun/Public/images/qrcode_002.png" src="http://api.item.yixun.com/2dcode/qrcode?scene=item&amp;size=230&amp;param=P%3D1118345%26Y%3D1500000" alt="商品二维码">
				...
				<div class="xextend" id="sea_daogou_wrap">
					<div id="jdinfo" style="display:block">
						<div class="xbrand" itemprop="brand" itemscope="" itemtype="http://schema.org/Brand">
							<p class="xbrand_info">此商品由<a href="javascript:;" itemprop="name">三虾网</a>提供并开具发票，提供配送及售后服务</p>
			...
			<div class="grid_m">
				<div class="grid_m_inner">
		  			...
		  			<div class="x_mod_tab xoverview x_mod_tab1" id="introduction">
						<div class="x_mod_tab_hd" id="info_tit">
		  					<ul class="x_mod_tab_nav">
		  						<li class="current" n="introduce" id="t_introduce">
									<a ytag="40001" href="javascript:;"><i class="xico xico_intro"></i>产品介绍</a>
		  						</li>
		  						<li n="comment" id="t_comment">
						...
						<div class="x_mod_tab_bd" id="intro-main_tab">
							<!-- 产品介绍 -->
		  					<div style="display: block;" class="x_mod_tab_con intro-main hide" id="c_introduce">
		  						<div id="detail_info">
							...
							<!-- 售后服务 -->
		  					<div class="x_mod_tab_con hide" id="c_warranty">
		  						<div class="mod_aider">
		  						<div class="i_hd"><div class="mod_aider_tit">保修条款</div></div><div class="i_bd"><p>质保期：一年质保 如因质量问题或故障，凭厂商维修中心或特约维修点的质量检测证明，享受7日内退货，15日内换货，15日以上在质保期内享受免费保修等三包服务！</p></div></div><div class="mod_aider"><div class="i_hd"><div class="mod_aider_tit">售后条款</div></div><div class="i_bd"><div class="mod_warranty id_deadline"><div class="mod_warranty_hd"><div class="mod_aider_tit">保障时效</div></div><div class="mod_warranty_bd"><p>所购产品如出现国家三包所规定的性能故障，经由厂商指定或特约维修点确认故障确实。售后保障时效如下：</p><div class="deadline"><div class="deadline_item"><div class="img img1"></div><p>7日内,您可以选择退货、换货或者免费保修。</p></div><div class="deadline_item"><div class="img img2"></div><p>第8日至第15日内,您可以选择换货或者免费保修。</p></div><div class="deadline_item noborder"><div class="img img3"></div><p>超过15日并在保修期内,您可以享受免费保修。</p></div></div></div></div><div class="mod_warranty id_promise"><div class="mod_warranty_hd"><div class="mod_aider_tit">三虾承诺</div></div><div class="mod_warranty_bd"><dl class="promise"><dd class="item"><dl><dt class="promise_i1">正品行货</dt><dd>三虾网销售商品均由供应商或供销商提供，行货正品。</dd></dl></dd><dd class="item"><dl><dt class="promise_i2">修养保障</dt><dd>三虾网销售商品均可享受原厂保修或供应商提供的更换、维修和保养服务；厂家和供应商有责任履行相应责任及义务，为用户提供相应的保修、更换、维修和保养服务。</dd></dl></dd><dd class="item"><dl><dt class="promise_i3">权益维护</dt><dd>当用户向厂家或供应商争取相关权益及应有服务时，三虾网会在用户需要的第一时间提供有关的联系及协调服务，协助用户维护自己应有的权益。</dd></dl></dd><dd class="item"><dl><dt class="promise_i4">正规发票</dt><dd>三虾网会为所有客户开具发票作为客户的质保凭证，请顾客自行保留原件作为后续质保之需。</dd></dl></dd></dl></div></div><div class="mod_warranty id_flow"><div class="mod_warranty_hd"><div class="mod_aider_tit">处理流程</div></div><div class="mod_warranty_bd"><img class="img2" src="/yixun/Public/images/process_flow.png" height="285" width="873"><img class="img1" src="/yixun/Public/images/process_flow_985.png" height="285" width="643"></div></div><div class="mod_warranty id_way"><div class="mod_warranty_hd"><div class="mod_aider_tit">办理方式</div></div><div class="mod_warranty_bd"><div class="item way1"><div class="way_hd"><h4>三虾网全国联保，网上报修</h4></div><div class="way_bd"><p>您只需进入到<span>“<a target="_blank" href="http://base.yixun.com/index.html">我的三虾</a>”-“<a target="_blank" href="http://base.yixun.com/myrepair.html">报修/退换货</a>”</span>中直接提交报修/退换货申请即可，我们的工作人员会在24小时内审核确认（节假日审核时间可能会有延迟）做后续处理。</p></div></div><div class="item way2"><div class="way_hd"><h4>三虾网售后服务电话</h4></div><div class="way_bd"><p>在产品保修期内，如果您有售后问题需要咨询或者办理，欢迎您拨打我们的客服热线: </p><p><span>上海站：400-828-1878</span>（周一至周六9：00-18：00）</p><p><span>深圳站：400-828-6699</span>（周一至周六9：00-18：00）</p><p><span>北京站：400-828-0055</span>（周一至周六9：00-18：00）</p></div></div></div></div></div></div>
		  					</div>
							<!-- 商品评论 -->
				  			<div id="c_packinglist" class="x_mod_tab_con">
				  				<div class="hd">
											...
											<div class="xrating">
												<div class="xrating_row1 clearfix">
													...
													<div class="xrating_col">
														...
														<div class="xrating_count">共<strong class="xreview_num xrating_count_num"><?php echo ($count); ?></strong>位虾友参与评分</div>
													</div>
												</div>
											</div>
										</div>
		  			...
		  			<div class="mod_aider id_state" id="statement">
						...
						<div class="bd">
							<p class="strong state_cont">因厂家会在没有任何提前通知的情况下更改产品包装、产地或者一些附件，三虾不能确保客户收到的货物与三虾图片、产地、附件说明完全一致。只能确保为原厂正货！并且保证与当时市场上同样主流新品一致。另外商品的规格参数均以官方网站为准，若官网有误或三虾没有及时更新，请大家谅解！</p>
						</div>
		  			</div>
		  			<!-- S 购买咨询-->
				  						...
				  						<li>
				  							<div class="mod_goods x_mod_goods">
				  								<div class="mod_goods_img">
				  									<a target="_blank" href="/yixun/index.php/home/goods/index/gid/<?php echo ($vo["gid"]); ?>" title="<?php echo ($vo["gname"]); ?>">
				  										<img src="/yixun/Public/goodsuploads/<?php echo (implode('/120_',explode('/',$vo["gpic"]))); ?>" alt="<?php echo ($vo["gname"]); ?>">
				  									</a>
				  								</div>
				  								<div class="mod_goods_info">
				  									<p class="mod_goods_tit">
				  										<a target="_blank" href="/yixun/index.php/home/goods/index/gid/<?php echo ($vo["gid"]); ?>" title="<?php echo ($vo["gname"]); ?>"><?php echo ($vo["gname"]); ?></a>
				  									</p>
			...
			<div class="mod_carttip_bd clearfix">
				...
				<div class="mod_carttip_con">
					...
					<div class="mod_carttip_action">
						<a class="mod_carttip_btn mod_carttip_btn_bg2 mod_carttip_btn1" onclick="$('.mod_carttip_close').click()" href="/yixun/index.php/home/Showcart" >
							<span>去结算</span>
						</a>
    ...
    <div class="ic_market" id="j_market">
        <div class="grid_c1">
            <a class="market_link"><img src="/yixun/Public/home/images/foot.jpg" class="market_img_1"></a>
        </div>
    </div>
        <div class="ic_footer_inner">
            ...
            <div class="mod_help">
                <div class="mod_help_item">
                    <h5>常用服务</h5>
                    <ul>
                        <li><a target="_blank" href="/yixun/index.php/Home/service/index" rel="nofollow">问题咨询</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/service/AmendIndent" rel="nofollow">修改订单</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/service/Favorable" rel="nofollow">取消订单</a></li>
                    </ul>
                </div>
                <div class="mod_help_item">
                    <h5>常用服务</h5>
                    <ul>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/register" rel="nofollow">新用户注册</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/login" rel="nofollow">用户登录</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/communication" rel="nofollow">沟通相关</a>
                    </ul>
                </div>
                <div class="mod_help_item">
                    <h5>常用服务</h5>
                    <ul>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/presales" rel="nofollow">售前相关</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/transaction" rel="nofollow">交易相关</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/logistics" rel="nofollow">物流相关</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/after" rel="nofollow">售后相关</a></li>
                        </li>
                    </ul>
                </div>
                <div class="mod_help_item">
                    <h5>常用服务</h5>
                    <ul>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/integral" rel="nofollow">积分介绍</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/member" rel="nofollow">会员制介绍</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/comment" rel="nofollow">评论介绍</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/balance" rel="nofollow">账户余额介绍</a></li>
                    </ul>
                </div>
                <div class="mod_help_item">
                    <h5>常用服务</h5>
                    <ul>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/payment" rel="nofollow">货到付款</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/line" rel="nofollow">在线支付</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/bill" rel="nofollow">发票说明</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/favorable" rel="nofollow">优惠劵介绍</a></li>
                    </ul>
                </div>
                <div class="mod_help_item">
                    <h5>常用服务</h5>
                    <ul>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/yixun" rel="nofollow">易迅快递</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/common" rel="nofollow">普通快递</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/EMS" rel="nofollow">邮政EMS</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/user" rel="nofollow">用户条款</a></li>
                        <li><a target="_blank" href="/yixun/index.php/Home/Protocol/sun" rel="nofollow">阳光行动</a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="ic_subfooter">
        <div class="grid_c1">
            <div class="sf_p1">
                <a target="_blank" href="/yixun/index.php/Home/Protocol/yixun" rel="nofollow">易迅简介</a>|
                <a target="_blank" href="/yixun/index.php/Home/Protocol/user" rel="nofollow">易迅公告</a>|
                <a target="_blank" href="/yixun/index.php/Home/Protocol/sun" rel="nofollow">招纳贤士</a>|
	...
	<script type="text/javascript" src="/yixun/Public/home/js/gb.js"></script>
	<script type="text/javascript">
		...
		function ajaxhandle(){
			...
			$.ajax({
				url:"/yixun/index.php/Home/Goods/showCart",
				type:"post",
