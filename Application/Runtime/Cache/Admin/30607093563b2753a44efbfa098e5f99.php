	...
	<body>
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								查看会员信息
								<a class="btn btn-info btn-sm pull-right" href="/yixun/admin.php/Admin/Member/index">
						...
						<div class="row" style="margin-top:35px;">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="/yixun/admin.php/Admin/Member/update" method="post" enctype="multipart/form-data">
									<input type="hidden" name="adplace" value="1" />
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 用户名 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text"  name="uname" value="<?php echo ($data["uname"]); ?>" disabled>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 邮箱 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="email"  name="email" value="<?php echo ($data["email"]); ?>" disabled>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 会员等级 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" name="adurl" value="<?php echo ($data["level"]); ?>" disabled>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" > 积分 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text"  name="scores" value="<?php echo ($data["scores"]); ?>" disabled>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" > 余额 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text"  name="adurl" value="<?php echo ($data["balance"]); ?>" disabled>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" > 注册日期 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text"  name="adurl" value="<?php echo (date('Y-m-d H:i',$data["regtime"])); ?>" disabled>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" > 最后登录时间 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" name="adurl" value="<?php echo (date('Y-m-d H:i',$data["logintime"])); ?>" disabled>
										</div>
									</div>
								</form>
							</div><!-- /.col -->
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				//设置当前页面的菜单高亮显示 开始
				var nownav = "#sidebar a[href*=Member]";
