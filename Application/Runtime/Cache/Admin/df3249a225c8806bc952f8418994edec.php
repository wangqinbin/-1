				...
				<div class="col-xs-12">
					<form class="form-horizontal" role="form" action="<?php echo U('Admin/Indexset/editAd');?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input class="col-xs-10 col-sm-5" type="url" value="<?php echo ($adinfo['fadurl']); ?>" name="fadurl">
							</div>
						</div>
						<div class="form-group" style="margin-bottom:0px;">
							...
							<div class="col-sm-10">
                                ...
                                <img class="full-right" style="margin-left:10px;" src="/yixun/Public/Uploads/<?php echo (implode('/th_',explode('/',$adinfo['fadpic']))); ?>" height="30">
							</div>
						</div>
