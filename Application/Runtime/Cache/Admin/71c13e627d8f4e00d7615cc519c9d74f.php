				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row" style="margin-top:35px;">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="/yixun/admin.php/Admin/Member/add" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="password" placeholder="请填写密码" name="password">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 确认密码 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="password" placeholder="请确认密码">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 邮箱 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="email" placeholder="请填写邮箱" name="email">
										</div>
									</div>
									<!--文件上传-->
