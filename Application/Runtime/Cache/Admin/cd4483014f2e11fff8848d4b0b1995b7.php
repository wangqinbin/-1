...
<html lang="en">
                            ...
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <!--<div>
                                        <form action="/yixun/admin.php/Admin/Member/search" method="get" style="margin-bottom:5px;">
                                        ...
                                        <a href="/yixun/admin.php/Admin/Member/insert" class="btn btn-primary"><small><i class="icon-plus-sign bigger-125"></i>    添加用户</small></a>
                                        </form>
                                        </div>-->
                <!--搜索-->
                <div class="row" style="padding:0px;height:auto;overflow:hidden;margin-bottom:10px;">
                                <div class="col-xs-12 col-sm-8">
                                <a class="btn btn-primary pull-left" style="padding:1px 10px;" href="/yixun/admin.php/Admin/Member/insert">
                                    <i class="icon-plus-sign bigger-125"></i>
                                    添加用户
                                </a>
                            </div>
                            <div class="col-xs-12 col-sm-4">
                                <form action="/yixun/admin.php/Admin/Member/search" method="get">
                                    <div class="input-group pull-right">
                                        <input class="form-control search-query" type="text"  name="uname" placeholder="输入搜索内容...">
                                        ...
                                        <div class="table-responsive">
                                            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                                ...
                                                <!--一行的开始-->
                                                <!--遍历查询到的数据-->
                                                <?php if(is_array($user)): foreach($user as $key=>$v): ?><tbody>
                                                    <tr>
                                                        <td class="center">
                                                            <label>
                                                        ...
                                                        <td>
                                                            <a href="/yixun/admin.php/Admin/Member/mod/uid/<?php echo ($v["uid"]); ?>"><?php echo ($v["uname"]); ?></a>
                                                        </td>
                                                        ...
                                                        <td class="hidden-480"><?php echo ($v["level"]); ?></td>
                                                        <td><?php echo ($v["scores"]); ?></td>
        
                                                        <td class="hidden-480">
                                                            <span class="label label-sm label-warning">余额</span>
                                                        </td>
                                                        <td><?php echo (date("Y-m-d H:i",$v["regtime"])); ?></td>
                                                        <?php if($v["logintime"] == 0): ?><td></td>
                                                        <?php else: ?>
                                                        <td><?php echo (date("Y-m-d H:i",$v["logintime"])); ?></td><?php endif; ?>
    
                                                        <td>
                                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                                <a class="blue" href="/yixun/admin.php/Admin/Member/mod/uid/<?php echo ($v["uid"]); ?>">
                                                                ...
                                                                <a name="del_<?php echo ($v["uid"]); ?>" class="red" data-toggle="modal" href="#deleteModal">
    ...
    <script type="text/javascript">
                    ...
                    $.ajax({
                        url:"/yixun/admin.php/Admin/Member/del",
                        type:"get",
                        data:{uid:delid},
