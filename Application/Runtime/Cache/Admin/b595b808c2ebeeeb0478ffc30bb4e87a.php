...
<html lang="en">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">                    
                    ...
                    <p>
                    <?php if(authCheck('Admin/Indexset/index',session('uid'))): ?><a class="btn btn-app btn-default no-radius" href="<?php echo U('Admin/Indexset/index');?>">
                            <i class="icon-cog bigger-230"></i>
                            首页设置
                        </a><?php endif; ?>
                    <?php if(authCheck('Admin/Member/index',session('uid'))): ?><a class="btn btn-app btn-default no-radius" href="<?php echo U('Admin/Member/index');?>">
                    ...
                    <?php if(authCheck('Admin/Reviewmanage/index',session('uid'))): ?><a class="btn btn-app btn-default no-radius" href="<?php echo U('Admin/Reviewmanage/index');?>">
    ...
    <script src="/yixun/Public/admin/js/jquery.slimscroll.min.js"></script>
    <script src="/yixun/Public/admin/js/jquery.easy-pie-chart.min.js"></script>
    <script src="/yixun/Public/admin/js/jquery.sparkline.min.js"></script>
    <script src="/yixun/Public/admin/js/flot/jquery.flot.min.js"></script>
    <script src="/yixun/Public/admin/js/flot/jquery.flot.pie.min.js"></script>
    <script src="/yixun/Public/admin/js/flot/jquery.flot.resize.min.js"></script>
    <script type="text/javascript">
        jQuery(function($) {
            //设置当前页面的菜单高亮显示 开始
