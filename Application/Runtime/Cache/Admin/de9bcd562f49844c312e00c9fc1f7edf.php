...
<html lang="en">
	...
	<link rel="stylesheet" href="/yixun/Public/admin/css/datepicker.css" />
	...
	<div class="main-content">
		...
		<div class="page-content">
			...
			<div class="row" style="margin-top:35px;">
				<div class="col-xs-12">
					<form class="form-horizontal" role="form" action="<?php echo U('Admin/Indexset/insertAd');?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-10">
                                <div class="col-xs-10 col-sm-5  no-padding">
                                    <select class="form-control" name="fadplace">
                                        <option value="2"}>中间图片</option>
                                        <option value="1"}>左侧幻灯片</option>
                                        <option value="3">右侧广告</option>
                                    </select>
                                </div>
                            </div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input class="col-xs-10 col-sm-5" type="text" placeholder="请填写广告标题" name="fadtitle">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label no-padding-right"> 图片URL </label>
							<div class="col-sm-10">
								<input class="col-xs-10 col-sm-5" type="url" placeholder="请填写广告URL" name="fadurl">
							</div>
						</div>
							...
							<div class="col-sm-10">
								<div class="col-xs-10 col-sm-5 no-padding" >
									<div class="input-group">
										...
										<input style="height:30px;" class="form-control date-picker" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" name="fadstarttime" placeholder="请填写广告生效日期">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-sm-10">
								<div class="col-xs-10 col-sm-5 no-padding" >
									<div class="input-group">
										...
										<input style="height:30px;" class="form-control date-picker" id="id-date-picker-2" type="text" data-date-format="yyyy-mm-dd" name="fadendtime" placeholder="请填写广告失效日期">
									</div>
								</div>
							</div>
						</div>
	...
	<script src="/yixun/Public/admin/js/date-time/bootstrap-datepicker.min.js"></script>
	<script type="text/javascript">
		jQuery(function($) {
