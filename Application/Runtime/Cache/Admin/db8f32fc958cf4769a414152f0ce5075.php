    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo U('Admin/Grouplist/index');?>">角色管理</a>
                </li>
                 <li>
                    <a href="<?php echo U('Admin/Grouplist/groupMem',array('id'=>$_GET['id']));?>"><?php echo ($page['title']['prev']); ?></a>
                </li>
                <li class="active">
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <h1>
                    <?php echo ($page['title']['current']); ?>
                    <a class="btn btn-info btn-sm pull-right" href="<?php echo U('Admin/Grouplist/groupMem',array('id'=>$_GET['id']));?>">
            ...
            <div class="row" style="margin-top:35px;">
                <div class="col-xs-12">
                    <form class="form-horizontal" role="form" action="<?php echo U('Admin/Grouplist/insertMem');?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="group_id" value="<?php echo ($_GET['id']); ?>">
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right"> 所属角色组 </label>
                            <div class="col-sm-10">
                                <input class="col-xs-10 col-sm-5" type="text" value="<?php echo ($gtitle); ?>" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="col-xs-10 col-sm-5" type="text" placeholder="请填写用户名" name="uname">
                            </div>
                        </div>
