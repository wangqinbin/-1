    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="row" style="margin-top:35px;">
                <div class="col-xs-12">
                    <form class="form-horizontal" role="form" action="<?php echo U('Admin/Grouplist/updataGroup');?>" method="post">
                        <input type="hidden" name="id" value="<?php echo ($_GET['id']); ?>">
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right"> 角色名称 </label>
                            <div class="col-sm-10">
                                <input class="col-xs-10 col-sm-5" type="text" placeholder="请填写角色名称" value="<?php echo ($group['title']); ?>" name="title">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right"> 角色描述 </label>
                            <div class="col-sm-10">
                                <input class="col-xs-10 col-sm-5" type="text" placeholder="请填写角色描述" value="<?php echo ($group['description']); ?>" name="description">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label>
                                    <input id="group-tap" class="ace ace-switch ace-switch-6" type="checkbox" <?php echo ($group['status']?"checked":""); ?>>
                                    <span class="lbl"></span>
                                </label>
                            </div>
                            <input id="group-status" type="hidden" name="status" value="<?php echo ($group['status']); ?>">
                        </div>
                                                ...
                                                <div id="sel-<?php echo ($i); ?>" class="sel-collapse collapse in">
                                                    <div class="sel-body" id="check-<?php echo ($i); ?>">
                                                        <?php if(is_array($rule[$val['id']])): foreach($rule[$val['id']] as $key=>$vo): ?><div class="childsel">
                                                                    <input type="checkbox" class="ace ace-checkbox-2" name="rule[]" value="<?php echo ($vo['id']); ?>" <?php echo ($vo['ischeck']?'checked':''); ?>/>
