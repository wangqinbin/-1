...
class GoodsDownController extends Controller{
	...
	*/
	public function index(){
		...
		$datatotal = $goodsup->field('count(*) count')->where('issale=0')->find();
		// 计算满足条件的数据总数
		...
		// 连贯操作查询数据
		$goodupdata = $goodsup->field('gid,gpic,gname,goldprice,goodnums,gsellnums,gissuetime')->where('issale=0')->order('gissuetime desc')->limit($limit)->select();
