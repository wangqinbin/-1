...
<html lang="en">
    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo U('Admin/Accesslist/index');?>"><?php echo ($page['title']['prev']); ?></a>
                </li>
                <li class="active">
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <h1>
                    <?php echo ($page['title']['current']); ?>
                    <a class="btn btn-info btn-sm pull-right" href="<?php echo U('Admin/Accesslist/index');?>">
            ...
            <div class="row" style="margin-top:35px;">
                <div class="col-xs-12">
                    <form class="form-horizontal" role="form" action="<?php echo U('Admin/Accesslist/insertAccess');?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right"> 权限名称 </label>
                            <div class="col-sm-10">
                                <input class="col-xs-10 col-sm-5" type="text" placeholder="请填写权限名称" name="title">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right"> 权限标识 </label>
                            <div class="col-sm-10">
                                <input class="col-xs-10 col-sm-5" type="text" placeholder="请填写权限标识" name="name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right"> 附加条件 </label>
                            <div class="col-sm-10">
                                <input class="col-xs-10 col-sm-5" type="text" name="condition">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label>
                                    <input id="access-tap" class="ace ace-switch ace-switch-6" type="checkbox" checked>
                                    <span class="lbl"></span>
                                </label>
                            </div>
                            <input id="access-status" type="hidden" name="status" value="1">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" id="selparent">
                                <div id="menu-0" class="col-xs-10 col-sm-2  no-padding">
                                    <select class="form-control" name="mid">
                                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>"}><?php echo ($vo['moduleName']); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        $(function(){
            //设置当前页面的菜单高亮显示 开始
            var nownav = '#sidebar a[href*=Accesslist]';
            ...
            //设置当前页面的菜单高亮显示 结束
            $('#access-tap').click(function(){
                if ($('#access-status').val()==1) {
                    $('#access-status').val(0)
                }else{
                    $('#access-status').val(1)
                }
