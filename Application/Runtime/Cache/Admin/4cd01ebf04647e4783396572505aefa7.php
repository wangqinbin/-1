        ...
        <div class="page-content">
            ...
            <div class="row" style="padding:0px;height:auto;overflow:hidden;margin-bottom:10px;">
                <div class="col-xs-12 col-sm-8">
                    <a class="btn btn-primary pull-left" style="padding:1px 10px;" href="<?php echo U('Admin/Accesslist/addAccess');?>">
                    ...
                    <div class="table-responsive">
                        <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th class="width-15">规则名称</th>
                                    <th class="width-25">规则标识</th>
                                    <th class="width-15">附加条件</th>
                                    <th class="width-15">所属模块</th>
                                    <th>状态</th>
                            ...
                            <tbody>
                                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td>
                                        <div class="col-xs-3">
                                            <label>
                                                <input id="access-tap" class="ace ace-switch ace-switch-6" type="checkbox" <?php echo ($vo['status']?'checked':''); ?> name="switch-<?php echo ($vo['id']); ?>">
                                                <span class="lbl"></span>
                                            </label>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                            <a name="table-edit" class="green" href="<?php echo U('Admin/Accesslist/modifyAccess',array('id'=>$vo['id']));?>">
    ...
    <script type="text/javascript">
        jQuery(function($) {
            ...
            $('#delete-data').on('click',function(){
                $.ajax({
                       url:"/yixun/admin.php/Admin/Accesslist/deleteAccess",
                       type:"post",
                       data:{id:delid},
                       success:function(data){
                            if (data == 1) {
                                ...
                                warningInfo("#success-info","没有删除权限！");
                            }else{
            ...
            $('label').on('click','#access-tap',function(){
                var cgid = $(this).prop('name').split('-')[1];
                $.ajax({
                    url:"/yixun/admin.php/admin/Accesslist/accessState",
                    type:'post',
                    data:{id:cgid},
                    success:function(data){
                        if (data == 1) {
