...
class CouponmanageController extends AdminController {
    ...
    public function coupons(){
        ...
        $data = $viewcoupon -> table("sx_". $couponname." c,sx_coupongroups g")
    ...
    public function deleteCoupon(){
        ...
        if ($delcoupon -> delete($_POST['cgid'])) {
            $delsql = "DROP TABLE sx_coupons_{$_POST['cgid']}";
    ...
    private function createTable($id,$num,$prefix=''){
        ...
        $res = $create->query("CREATE TABLE IF NOT EXISTS sx_".$tablename." (
