...
<html lang="en">
	<head>
		...
		<link href="/yixun/Public/admin/css/bootstrap.min.css" rel="stylesheet" />
		<link rel="stylesheet" href="/yixun/Public/admin/css/font-awesome.min.css" />

		<!--[if IE 7]>
		  <link rel="stylesheet" href="/yixun/Public/admin/css/font-awesome-ie7.min.css" />
		<![endif]-->
		...
		<!--[if lte IE 8]>
		  <link rel="stylesheet" href="/yixun/Public/admin/css/ace-ie.min.css" />
		<![endif]-->
		...
		<!--[if lt IE 9]>
		<script src="/yixun/Public/admin/js/html5shiv.js"></script>
		<script src="/yixun/Public/admin/js/respond.min.js"></script>
		<![endif]-->
	</head>
	...
	<body class="login-layout">
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="space-6"></div>
											<form action="/yixun/admin.php/admin/login/checklogin" method="post">
												<fieldset>
		...
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='/yixun/Public/admin/js/jquery-1.10.2.min.js'>"+"<"+"/script>");
</script>
<![endif]-->
