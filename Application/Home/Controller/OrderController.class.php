...
class OrderController extends Controller{
	public function index(){
		...
		$list = M();
		// 多表查询
		$cartdata = $list->table('sx_goods g,sx_shoppingcart s')->field('s.cartid,g.gpic,g.gname,g.goldprice,s.nums,s.price gprice')->where('s.uid='.$uid.' and s.gid=g.gid')->select();
